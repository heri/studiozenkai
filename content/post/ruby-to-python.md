+++
date = "2019-06-08T10:35:26-04:00"
title = "Learning Python, A Rubyist's Perspective"
tags = ['software', 'ruby', 'python']
+++

Python is not so different from Ruby. Both languages feel intuitive, like an old tool in your hand. They speak in simple words, and their libraries reach far and wide. But for a Rubyist, Python is also a little strange, like walking backward on a familiar road.
...
You want the length of a string? Ruby says string.size. Python demands len(string). You think you can just cast a thing to a dictionary or list? Not so fast. You must explicitly convert it.
